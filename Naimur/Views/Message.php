...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/Naimur/Views/Message.css" />
    ...
    <div class="container">
        ...
        <div class="main item3">
            ...
            <div id="embed-container">
                <iframe src="https://dashboard.tawk.to/#/dashboard" width="100%" height="100%" frameborder="0"></iframe>
            </div>
